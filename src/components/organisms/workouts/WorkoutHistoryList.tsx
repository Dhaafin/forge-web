    ...
    sets: [
      {
        ...
        reps: 10,
        is_pr: true,
        exercise: { id: "ex-1", name: "Incline Bench Press", target_muscle: "Chest" },
      },
      {
        id: "set-2",
        exercise_id: "ex-1",
      ...
      },
      {
        ...
        reps: 12,
        is_pr: false,
        exercise: { id: "ex-2", name: "Dumbbell Shoulder Press", target_muscle: "Shoulders" },
      },
      {
        id: "set-4",
        exercise_id: "ex-3",
        ...
        reps: 15,
        is_pr: false,
        exercise: { id: "ex-3", name: "Lateral Raise", target_muscle: "Shoulders" },
      },
    ],
  },
  {
    ...
    sets: [
      {
        ...
        reps: 5,
        is_pr: true,
        exercise: { id: "ex-4", name: "Barbell Back Squat", target_muscle: "Quads" },
      },
      {
        id: "set-6",
        exercise_id: "ex-4",
      ...
      },
      {
        ...
        reps: 8,
        is_pr: true,
        exercise: { id: "ex-5", name: "Seated Leg Press", target_muscle: "Quads" },
      },
    ],
  },
  {
    ...
    sets: [
      {
        ...
        reps: 8,
        is_pr: false,
        exercise: { id: "ex-6", name: "Weighted Pull-up", target_muscle: "Lats" },
      },
      {
        id: "set-9",
        exercise_id: "ex-7",
        ...
        reps: 10,
        is_pr: false,
        exercise: { id: "ex-7", name: "Bent Over Barbell Row", target_muscle: "Back" },
      },
    ],
  },
];
...
export const WorkoutHistoryList: React.FC = () => {
  ...
  const startEdit = (e: React.MouseEvent, session: WorkoutSession) => {
    ...
    setEditSets(JSON.parse(JSON.stringify(session.sets || [])));
    setDeletedSetIds([]);
    setIsEditOpen(true);
  };
  ...
  const applyLocalFilters = (rawList: WorkoutSession[]) => {
    ...
    if (timeWindow) {
      ...
      else if (timeWindow === "ytd") timeThreshold.setMonth(0, 1);
